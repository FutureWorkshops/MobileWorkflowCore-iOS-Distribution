Pod::Spec.new do |s|
    ...
    s.version               = 'chore/update-welba-recorder'
    ...
    s.source                = { :http => 'https://raw.github.com/FutureWorkshops/MobileWorkflowCore-iOS-Distribution/chore/update-welba-recorder/MobileWorkflowCore.zip' }
    s.platform              = :ios
    s.swift_version         = '5'
