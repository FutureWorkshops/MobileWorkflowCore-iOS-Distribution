...
SWIFT_CLASS("_TtC11ResearchKit17CurrencyFormatter")
...
@interface CurrencyFormatter (SWIFT_EXTENSION(ResearchKit))
/// Returns a currency string from a given double value.
/// \param double the monetary amount.
///
///
/// returns:
/// formatted currency string.
- (NSString * _Nullable)stringFrom:(double)double_ SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC11ResearchKit27CurrencyUITextFieldDelegate")
...
@interface CurrencyUITextFieldDelegate (SWIFT_EXTENSION(ResearchKit)) <UITextFieldDelegate>
